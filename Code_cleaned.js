 ...
 * E
xtract student roster from sheet.
 ...
 * Wr
ite updates to the Log sheet only (daily sheet remains read-only).
...
function updateStatus(studentName, action, teacherName, gender) {
 ...
 true if a student of that gender is currently out (i.e. has an outTime but no backTime) */
 ...
 * F
ormat a Date object to "H:MM AM/PM" format (12-hour time)
 ...
 * De
bug function to check what's in the Log sheet
 */
 ...
 * Mi
dnight Reset Function - Automatically clears daily roster cache
